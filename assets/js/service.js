...
// ============================================
// ============================================
// (ID يطابق الموجود في صفحة التفاصيل)
// ============================================
const services = [
    {
        id: 1, 
        ...
        detailsUrl: `product-details.html?id=1`, // الربط باستخدام الـ ID
        price: 2000, 
        rating: 5
    },
    {
        ...
        detailsUrl: `product-details.html?id=2`, // الربط باستخدام الـ ID
        price: 2000, 
        rating: 4
    },
    {
        ...
        detailsUrl: `product-details.html?id=3`, // الربط باستخدام الـ ID
        price: 2000, 
        rating: 5
    },
    {
        ...
        detailsUrl: `product-details.html?id=4`, // الربط باستخدام الـ ID
        price: null, 
        rating: 5
    },
    {
        ...
        detailsUrl: `product-details.html?id=5`, // الربط باستخدام الـ ID
        price: 1500, 
        rating: 5
    }
];
...
// ============================================
// وظيفة إنشاء بطاقة الخدمة (تعديل رابط التفاصيل)
// ============================================
